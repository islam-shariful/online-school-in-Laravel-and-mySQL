...
(2, '20-0002-02', 'Raiyan123@#', 'schooladmin'),
(3, '20-0000-01', 'Raiyan123@#', 'superadmin'),
(4, '20-0001-02', 'Raiyan123@#', 'schooladmin'),
...
(1, '20-0000-02', 'raiyanislam', 'raiyan@gmail.com'),
(2, '20-0001-02', 'raiyanislam', 'raiyan@gmail.com');
...
(10, '20-8110-03', 'Mr. Teacher Agriculture', 'teacherA@gmail.com', 'Lecturer', 'Agriculture', '98/2,Dhanmondi. 32 Dhaka-1209', '5/2/1986', 'Male', 'Muslim', '2010-01-01', 'Mr. Alam', 'Mrs. Alam', 80);
...
(10, 8003, 'Asset 2.png', '2020-08-14 03:52:43', '20-8101-04');
...
--
ALTER TABLE `upload`
  MODIFY `upload_id` int(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=11;
COMMIT;
