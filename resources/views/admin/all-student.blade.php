...
<!-- Mirrored from www.radiustheme.com/demo/html/psdboss/akkhor/akkhor/all-student.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 16 Jul 2020 15:10:29 GMT -->
                    ...
                    <ul class="nav nav-sidebar-menu sidebar-toggle-view">
                        ...
                        <li class="nav-item sidebar-nav-item">
                            ...
                            <ul class="nav sub-group-menu sub-group-active">
                                <li class="nav-item">
                                    <a href="/all-student" class="nav-link menu-active"><i class="fas fa-angle-right"></i>All
                                        Students</a>
                                </li>
                                <li class="nav-item">
                            ...
                            <table class="table display data-table text-nowrap">
                                ...
                                <tbody >
                                     @for($i=0; $i != count ($students); $i++)
                                        ...
                                        <td><a href="/update-student/{{$students[$i]->sid}}"  class="btn-fill-lg bg-blue-dark btn-hover-yellow" >UPDATE</a>  <a href="/delete-student/{{$students[$i]->sid}}" class="btn-fill-lg btn-gradient-yellow"  > DELETE </a></td>
                                        <td>
                                            <div class="dropdown">
