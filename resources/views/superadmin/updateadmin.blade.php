              ...
              <div class="card-body">
                <div class="card card-info">
                    ...
                    @csrf
                            ...
                            value="{{$schooladmin->schooladmin_id}}" readonly>
                            <br>
                            
                            <label for="adminname" class="col-sm-2 col-form-label">User Name</label>
                            <br>
                            <input type="text" class="form-control" name="username" value="{{$schooladmin->schooladminname}}" id="userid" placeholder="User Name">
                            <br>
                            
                            <label for="inputEmail3" class="col-sm-2 col-form-label">Email</label>
                            <br>
                            <input type="email" name="email" class="form-control" value="{{$schooladmin->schooladminemail}}" id="inputEmail3" placeholder="Email">
                            <br>
                            
                            <label for="inputPassword3" class="col-sm-2 col-form-label">Password</label>
                            <br>
                            <input type="password" name="password_input" value="{{$password->userpassword}}" class="form-control" placeholder="Password">
                            <br>
