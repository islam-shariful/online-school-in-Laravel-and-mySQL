                    ...
                    <ul class="nav nav-sidebar-menu sidebar-toggle-view">
                        ...
                        <li class="nav-item sidebar-nav-item">
                            ...
                            <ul class="nav sub-group-menu sub-group-active">
                                <li class="nav-item">
                                    <a href="/adminHome/all-student" class="nav-link menu-active"><i class="fas fa-angle-right"></i>All
                                        Students</a>
                                </li>
                                <li class="nav-item">
                            ...
                            <table class="table display data-table text-nowrap">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td><a  class="btn-fill-lg bg-blue-dark btn-hover-yellow" >UPDATE</a>  <a href="/adminHome/delete/<%= studentList[i].sid %>" class="btn-fill-lg btn-gradient-yellow"  > DELETE </a></td>
                                        <td>
                                            <div class="dropdown">
